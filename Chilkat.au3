...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_ObjCreate_Wrapper
; Description ...: Creates a Chilkat COM object through registered ActiveX or DLL-based fallback logic.
; Syntax ........: __Chilkat_ObjCreate_Wrapper($iChilkatObjectName_IDX)
; Parameters ....: $iChilkatObjectName_IDX - [in] index from the $CHILKATOBJ_NAME_* enumeration.
; Return values .: Success: Chilkat COM object. Failure: $CHILKAT_RET_FAILURE and sets @error/@extended.
; Author ........: mLipok
; Modified ......:
; Remarks .......: Header generated by #AI - For internal use only. Requires _Chilkat_DllVersion() / _Chilkat_StartUp() setup according to the selected mode.
; Related .......: __Chilkat_Log, __Chilkat_ConsoleWrite_IFNC, _Chilkat_ObjName_FlagsValue, __Chilkat_LogOnError
; Link ..........:
; Example .......: No
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_ObjCreate_ByProgIdSuffix
; Description ...: Creates a Chilkat COM object by ProgID suffix when the object is not present in ChilkatConstants.au3.
; Syntax ........: __Chilkat_ObjCreate_ByProgIdSuffix($sClassName)
; Parameters ....: $sClassName            - [in] class name suffix, for example "Pkcs11" or "XmlDSigGen".
; Return values .: Success: Chilkat COM object. Failure: $CHILKAT_RET_FAILURE and sets @error/@extended.
; Author ........: AI / mLipok
; Modified ......:
; Remarks .......: Uses registered ActiveX ProgIDs: Chilkat.<ClassName> and Chilkat_9_5_0.<ClassName>. It does not use DLL attach fallback.
; Related .......: __Chilkat_ObjCreate_Wrapper, __Chilkat_LogOnError
; Link ..........: https://www.chilkatsoft.com/refdoc/activex.asp
; Example .......: No
; ===============================================================================================================================
...
; Author ........: AI / mLipok
; Modified ......:
; Remarks .......: Uses ChilkatConstants.au3 object metadata through __Chilkat_ObjCreate_Wrapper().
; Related .......: __Chilkat_ObjCreate_Wrapper
...
; Author ........: AI / mLipok
; Modified ......:
; Remarks .......: Used for XMLDSig / XAdES verification.
; Related .......: __Chilkat_ObjCreate_Wrapper
...
; Author ........: AI / mLipok
; Modified ......:
; Remarks .......: Used for XMLDSig / XAdES creation.
; Related .......: __Chilkat_ObjCreate_Wrapper
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_IsValidObject
; Description ...: Validates that the supplied value is a Chilkat COM object.
; Syntax ........: __Chilkat_IsValidObject($oObject)
; Parameters ....: $oObject               - [in] object to validate.
; Return values .: Success: $CHILKAT_RET_SUCCESS. Failure: $CHILKAT_RET_FAILURE and sets @error/@extended.
; Author ........: mLipok
; Modified ......:
; Remarks .......: Header generated by #AI - For internal use only.
; Related .......: __Chilkat_Log
; Link ..........:
; Example .......: No
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_Log
; Description ...: Writes a diagnostic message through the configured Chilkat log wrapper.
; Syntax ........: __Chilkat_Log($sText, $iError = @error, $iExtended = @extended)
; Parameters ....: $sText                 - [in] text to write to the configured log wrapper.
...
; Return values .: Success: restores supplied @error/@extended values.
; Author ........: mLipok
; Modified ......:
; Remarks .......: Header generated by #AI - For internal use only.
; Related .......: _Chilkat_LogWrapper
; Link ..........:
; Example .......: No
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_LogOnError
; Description ...: Writes Chilkat diagnostic information when @error or @extended indicates a problem.
; Syntax ........: __Chilkat_LogOnError($sText, $oLastError = Null, $iError = @error, $iExtended = @extended)
; Parameters ....: $sText                 - [in] text to write to the configured log wrapper.
;                  $oLastError            - [in] optional Chilkat object that exposes LastErrorText. Default is Null.
;                  $iError                - [in] @error value to preserve/restore. Default is @error.
;                  $iExtended             - [in] @extended value to preserve/restore. Default is @extended.
; Return values .: Success: restores supplied @error/@extended values.
; Author ........: mLipok
; Modified ......:
; Remarks .......: Header generated by #AI - For internal use only.
; Related .......: _Chilkat_ErrorLogWrapper
; Link ..........:
; Example .......: No
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Fake_COM_ERROR_HANDLER__for_Chilkat
; Description ...: Internal placeholder COM error handler used while probing COM object creation.
; Syntax ........: __Fake_COM_ERROR_HANDLER__for_Chilkat(ByRef $oError)
; Parameters ....: $oError                - [in/out] AutoIt COM error object.
; Return values .: Internal COM handler return value.
; Author ........: mLipok
; Modified ......:
; Remarks .......: Header generated by #AI - For internal use only.
; Related .......:
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Internal_COM_ERROR_HANDLER__for_Chilkat
; Description ...: Internal COM error handler that stores the last COM error text.
; Syntax ........: __Internal_COM_ERROR_HANDLER__for_Chilkat(ByRef $oError)
; Parameters ....: $oError                - [in/out] AutoIt COM error object.
; Return values .: Success: sets @error to $CHILKAT_ERR_COMERROR and @extended to $CHILKAT_EXT_DEFAULT.
; Author ........: mLipok
; Modified ......:
; Remarks .......: Header generated by #AI - For internal use only.
; Related .......: __Chilkat_Log
...
#Region - _Chilkat_ZIP_* helper functions
...
#EndRegion - _Chilkat_ZIP_* helper functions

#Region - _Chilkat_FTP2_* helper functions
...
#EndRegion - _Chilkat_FTP2_* helper functions

#Region - _Chilkat_HTTP_* functions

; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_GetAndSaveFileToDisc_Progress
; Description ...: Internal default progress callback for file download helpers.
; Syntax ........: __Chilkat_GetAndSaveFileToDisc_Progress($iProgress)
; Parameters ....: $iProgress             - [in] progress value in percent.
; Return values .: None.
; Author ........: mLipok
; Modified ......:
; Remarks .......: Header generated by #AI - For internal use as a default progress callback.
; Related .......: __Chilkat_Log
; Link ..........:
; Example .......: No
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_Array_CreateEmpty2D
; Description ...: Creates an empty 2D array with the requested column count.
; Syntax ........: __Chilkat_Array_CreateEmpty2D($iCols)
; Parameters ....: $iCols                 - [in] number of columns.
; Return values .: Empty 2D array.
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_Array_SetCertRow
; Description ...: Fills one row in a certificate metadata array.
; Syntax ........: __Chilkat_Array_SetCertRow(ByRef $aCerts, $iRow, ByRef $oCert, $iIndex)
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_Cert_QualifiedPolicyOidFromXml
; Description ...: Returns known EU qualified certificate policy OID from Certificate Policies XML, or empty string.
; Syntax ........: __Chilkat_Cert_QualifiedPolicyOidFromXml($sXml)
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_Cert_QualifiedTypeFromOid
; Description ...: Returns a short policy name for known EU qualified certificate policy OIDs.
; Syntax ........: __Chilkat_Cert_QualifiedTypeFromOid($sOid)
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_NowCalcUtc
; Description ...: Returns current UTC time as YYYY/MM/DD HH:MM:SS.
; Syntax ........: __Chilkat_NowCalcUtc()
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_Rfc822MonthToNumber
; Description ...: Converts RFC822 month name to number.
; Syntax ........: __Chilkat_Rfc822MonthToNumber($sMonth)
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_Rfc822GmtToCalc
; Description ...: Converts Chilkat GMT/UTC RFC822 date string to YYYY/MM/DD HH:MM:SS.
; Syntax ........: __Chilkat_Rfc822GmtToCalc($sRfc822)
; ===============================================================================================================================
...
#Region - _Chilkat_XADES_* helper functions

; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_PathGetFileName
; Description ...: Returns the final file name segment from a path.
; Syntax ........: __Chilkat_PathGetFileName($sFileFullPath)
; Parameters ....: $sFileFullPath         - [in] file path.
; Return values .: Filename string.
; Author ........: AI / mLipok
; Modified ......:
; Remarks .......: Internal helper for external-reference XAdES URIs.
; Related .......: _Chilkat_XADES_SignExternalFile_BES_ByCert
; Link ..........:
; Example .......: No
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_PathGetDir
; Description ...: Returns the directory part of a path.
; Syntax ........: __Chilkat_PathGetDir($sFileFullPath)
; Parameters ....: $sFileFullPath         - [in] file path.
; Return values .: Directory string, or "." when no directory is present.
; Author ........: AI / mLipok
; Modified ......:
; Remarks .......: Internal helper for external-reference XAdES verification.
...
; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_XADES_DigestAlgorithmUri
; Description ...: Returns XMLDSig digest algorithm URI for common digest names.
; Syntax ........: __Chilkat_XADES_DigestAlgorithmUri($sDigestMethod)
; Parameters ....: $sDigestMethod         - [in] sha1, sha256, sha384 or sha512.
; Return values .: Digest URI. Failure: $CHILKAT_RET_FAILURE and sets @error/@extended.
; Author ........: AI / mLipok
; Modified ......:
; Remarks .......: Internal helper for XAdES SigningCertificateV2 DigestMethod.
; Related .......: _Chilkat_XADES_SignExternalFile_BES_ByCert
; Link ..........:
; Example .......: No
; ===============================================================================================================================
...
#EndRegion - _Chilkat_XADES_* helper functions

; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name ..........: __Chilkat_ConsoleWrite_IFNC
; Description ...: Writes diagnostic data to the console only when the script is not compiled.
; Syntax ........: __Chilkat_ConsoleWrite_IFNC($sData, $iError = @error, $iExtended = @extended)
; Parameters ....: $sData                 - [in] data to write to the console when script is not compiled.
;                  $iError                - [in] @error value to preserve/restore. Default is @error.
;                  $iExtended             - [in] @extended value to preserve/restore. Default is @extended.
; Return values .: Success: restores the supplied @error/@extended values.
; Author ........: mLipok
; Modified ......:
; Remarks .......: Header generated by #AI - For internal diagnostics; IFNC means "if not compiled".
; Related .......:
; Link ..........:
; Example .......: No
; ===============================================================================================================================
