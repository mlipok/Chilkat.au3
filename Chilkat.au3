...
#cs
	...
	#AI from v0.3.0 onward - whenever a new UDF function is added, update the current Release Notes entry in the same change.
	#AI while a version is still in development, revise and extend its latest Release Notes entry instead of leaving an incomplete summary.
