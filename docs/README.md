...
The documentation reflects the modular source layout developed on the `the_way_to_0.3.x` branch. `Chilkat.au3` remains the primary include file and the single entry point for application scripts.
...
- [Transfer and networking](transfer-networking.md)
- [Cloud storage](cloud-storage.md)
- [Google APIs and CRUD](google.md)
...
- [Code signing, PAdES TSA timestamps, and SCard](codesign-pades-tsa-scard.md)
...
The current source function headers remain authoritative for exact function signatures, return values, `@error`, `@extended`, supported Chilkat versions, and object metadata.
...
- `Chilkat_DataFormats.au3` — ASN.1, Base64, CSV, HTML conversion, JSON, Markdown, and XML.
- `Chilkat_Authentication.au3` — NTLM, OAuth1, OAuth2, and OIDC.
- `Chilkat_TransferNetworking.au3` — FTP, HTTP, REST, SSH, SFTP, sockets, and related transfer protocols.
- `Chilkat_CloudStorage.au3` — AWS/Azure authentication, S3, and generic cloud REST support.
...
Release Notes are maintained in `RELEASE_NOTES.md` in the repository root.
